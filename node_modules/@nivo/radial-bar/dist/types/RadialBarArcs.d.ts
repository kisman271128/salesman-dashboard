...
export declare const RadialBarArcs: <D extends RadialBarDatum>({ center, bars, borderWidth, borderColor, arcGenerator, isInteractive, tooltip, onClick, onMouseEnter, onMouseMove, onMouseLeave, transitionMode, }: RadialBarArcsProps<D>) => import("react/jsx-runtime").JSX.Element;
export {};
